...
final class PersianKeywordServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        $this->app->singleton(KeywordScorer::class, function (): FrequencyKeywordScorer {
            /** @var array{title_weight?: float, body_weight?: float, title_phrase_weight?: float, body_phrase_weight?: float, entity_boost?: float, event_boost?: float, person_boost?: float, facility_boost?: float, long_organization_boost?: float} $options */
