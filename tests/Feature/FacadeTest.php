...
final class FacadeTest extends TestCase
{
    public function test_it_returns_a_structured_foundation_result(): void
    {
        ...
        self::assertSame('نمونه', $result->keywords()[0]);
        self::assertContains('نمونه متن', $result->keywords());
        self::assertSame(['نمونه', 'نمونه', 'متن', 'آزمایشی'], $result->tokens());
        self::assertSame(['نمونه متن', 'متن آزمایشی', 'نمونه متن آزمایشی'], $result->phrases());
