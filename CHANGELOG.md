...
- Canonical native recognition for `بازگشت به تلویزیون`, `نگارش و ساخت`, `مازیار لرستانی`, and `تله‌فیلم`.

### Improved

- Unified separated `تله فیلم` spellings as `تله‌فیلم` and removed incomplete fragments.
